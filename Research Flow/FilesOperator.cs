...
namespace Research_Flow
{
    public class FilesOperator
    {
        ...
        public async static Task generateImage(StorageFile file, InkCanvas inkCanvas)
        {
        ...
        public async static Task generateImage(StorageFile file, InkCanvas inkCanvas, Color color, Image back_image = null, IRandomAccessStream x = null)
        {
            CanvasDevice device = CanvasDevice.GetSharedDevice();
